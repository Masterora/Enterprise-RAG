...
const errorRules: Array<{ patterns: string[]; key: string }> = [
  { patterns: ['incorrect api key', 'invalid api-key', 'invalid_api_key', 'api key is required'], key: 'logs.error.invalidApiKey' },
	{ patterns: ['model is required', 'base url is required', 'unsupported llm provider', 'unsupported embedding provider'], key: 'logs.error.providerConfig' },
  ...
  { patterns: ['llm compatible chat request failed'], key: 'logs.error.compatibleChat' },
  { patterns: ['llm compatible stream request failed'], key: 'logs.error.compatibleStream' },
  { patterns: ['embedding compatible request failed'], key: 'logs.error.compatibleEmbedding' },
  { patterns: ['query rewrite failed'], key: 'logs.error.queryRewrite' },
